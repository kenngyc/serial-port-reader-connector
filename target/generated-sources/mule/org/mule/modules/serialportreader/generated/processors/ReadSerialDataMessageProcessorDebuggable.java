...
public class ReadSerialDataMessageProcessorDebuggable
    extends ReadSerialDataMessageProcessor
    implements DebugInfoProvider
{


    public ReadSerialDataMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
