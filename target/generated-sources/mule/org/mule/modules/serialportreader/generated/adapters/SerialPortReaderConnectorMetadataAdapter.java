...
/**
 * A <code>SerialPortReaderConnectorMetadataAdapter</code> is a wrapper around {@link SerialPortReaderConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-01-05T09:20:39+08:00", comments = "Build UNNAMED.2793.f49b6c7")
public class SerialPortReaderConnectorMetadataAdapter
    extends SerialPortReaderConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "Serial Port Reader";
